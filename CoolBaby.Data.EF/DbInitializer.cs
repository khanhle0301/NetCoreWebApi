...
namespace CoolBaby.Data.EF
{
    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            //if (_context.Perfumes.Count() == 0)
            //{
            //    List<Perfume> listSize = new List<Perfume>()
            //    {
            //        new Perfume() { Name="XXL" },
            //        new Perfume() { Name="XL"},
            //        new Perfume() { Name="L" },
            //        new Perfume() { Name="M" },
            //        new Perfume() { Name="S" },
            //        new Perfume() { Name="XS" }
            //    };
            //    _context.Perfumes.AddRange(listSize);
            //}
            ...
            //    {
            //        new Brand(){DateCreated=DateTime.Now,DateModified=DateTime.Now, Name="Brand 1", Image="/client-side/images/Brand/b1.jpg",SeoAlias="brand-1",SortOrder=1,Status=Status.Active},
            //        new Brand(){DateCreated=DateTime.Now,DateModified=DateTime.Now, Name="Brand 2", Image="/client-side/images/Brand/b2.jpg",SeoAlias="brand-2",SortOrder=2,Status=Status.Active},
            //        new Brand(){DateCreated=DateTime.Now,DateModified=DateTime.Now, Name="Brand 3", Image="/client-side/images/Brand/b3.jpg",SeoAlias="brand-3",SortOrder=3,Status=Status.Active},
            //        new Brand(){DateCreated=DateTime.Now,DateModified=DateTime.Now, Name="Brand 4", Image="/client-side/images/Brand/b4.jpg",SeoAlias="brand-4",SortOrder=4,Status=Status.Active}
            //    };
            ...
            //            {
            //                new Product(){BrandId=1, Name = "Product 1",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-1",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 2",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-2",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 3",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-3",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 4",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-4",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 5",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-5",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //            }
            //        },
            //        new ProductCategory() { Name="Women shirt",SeoAlias="women-shirt",ParentId = null,Status=Status.Active ,SortOrder=2,
            //            Products = new List<Product>()
            //            {
            //                new Product(){BrandId=1,Name = "Product 6",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-6",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 7",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-7",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 8",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-8",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 9",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-9",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 10",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-10",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //            }},
            //        new ProductCategory() { Name="Men shoes",SeoAlias="men-shoes",ParentId = null,Status=Status.Active ,SortOrder=3,
            //            Products = new List<Product>()
            //            {
            //                new Product(){BrandId=1,Name = "Product 11",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-11",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 12",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-12",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 13",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-13",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 14",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-14",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 15",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-15",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //            }},
            //        new ProductCategory() { Name="Woment shoes",SeoAlias="women-shoes",ParentId = null,Status=Status.Active,SortOrder=4,
            //            Products = new List<Product>()
            //            {
            //                new Product(){BrandId=1,Name = "Product 16",DateCreated=DateTime.Now, Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-16",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 17",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-17",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 18",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-18",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 19",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-19",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //                new Product(){BrandId=1,Name = "Product 20",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-20",Price = 1000,Status = Status.Active,OriginalPrice = 1000},
            //            }}
            //    };
